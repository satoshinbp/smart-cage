...
SDI = OutputDevice(12)   # Serial Data Input
RCLK = OutputDevice(16)  # Register Clock
SRCLK = OutputDevice(20) # Shift Register Clock

# Define GPIO pins for digit selection on the 7-segment display
placePin = [OutputDevice(pin) for pin in (10, 22, 27, 17)]

# Define segment codes for numbers 0-9 for the 7-segment display
number_without_dot = (0xc0, 0xf9, 0xa4, 0xb0, 0x99, 0x92, 0x82, 0xf8, 0x80, 0x90)
number_with_dot = (0x40, 0x79, 0x24, 0x30, 0x19, 0x12, 0x02, 0x78, 0x00, 0x10)
...
def loop():
    ...
    while True:
        for i in range(4):  # Loop through each digit
            ...
            hc595_shift(number_with_dot[digit])  # Shift digit value to 74HC595
